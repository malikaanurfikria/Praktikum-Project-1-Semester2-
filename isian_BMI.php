...
<form>
  ...
  <div class="form-group row">
    <label for="text4" class="col-4 col-form-label">Kode Pasien</label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    <label for="text2" class="col-4 col-form-label">Berat(kg)</label> 
    <div class="col-8">
      <input id="berat" name="berat" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="text3" class="col-4 col-form-label">Tinggi(cm)</label> 
    <div class="col-8">
